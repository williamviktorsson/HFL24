          ...
          child: BlocBuilder<ItemsBloc, ItemsState>(
            builder: (context, itemsState) {
              return switch (itemsState) {
                ...
                ItemsLoaded(:final items, :final pending) => ListView.builder(
          ...
          save() {
            if (key.currentState!.validate()) {
              ...
              Navigator.of(context)
                  .pop(Item(description: description!, creatorId: user.id));
            }
          }
    ...
    save() {
      if (key.currentState!.validate()) {
        ...
        final Authenticated(:user) = context.read<AuthBloc>().state
            as Authenticated; // assume authenticated user
        Navigator.of(context).pop(
            Item(description: description!, creatorId: user.id, id: item.id));
      }
    }
